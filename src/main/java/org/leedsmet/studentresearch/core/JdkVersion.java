...
package org.leedsmet.studentresearch.core;
...
public abstract class JdkVersion {
	...
	static {
		...
		if (javaVersion.indexOf(JdkVersion._1_7) != -1) {
			majorJavaVersion = JAVA_17;
		} else if (javaVersion.indexOf(JdkVersion._1_6) != -1) {
			majorJavaVersion = JAVA_16;
		} else if (javaVersion.indexOf(JdkVersion._1_5) != -1) {
	...
	/**
	 * Convenience method to determine if the current JVM is at least Java 1.7
	 * (Java 6).
	 * 
